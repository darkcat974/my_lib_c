...
{
    char **arr = my_str_to_word_array("j'aime les chats sa mere", " .:!\n\0");
    char *ver[] = {"j'aime", "les", "chats", "sa", "mere", NULL};
    for (int i = 0; ver[i]; i++) {
...
{
    char *var = "je suis un chat miaou miaou/145/648/984/874/974";
    char ** arr = my_str_to_word_array(var, " /\n");
    char *bbb[] = {"je", "suis", "un", "chat", "miaou", "miaou", "145", "648", "984", "874", "974", NULL};
    for (int i = 0; bbb[i]; i++)
